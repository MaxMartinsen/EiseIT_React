      ...
      <div className="px-3 py-3 lg:px-5 lg:pl-3">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border bg-ebony-950 md:bg-transparent border-gray-100 rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0   dark:border-gray-700">
              <li>
                <NavLink
                  to={ROUTES.HOME}
                  className={({ isActive }) =>
